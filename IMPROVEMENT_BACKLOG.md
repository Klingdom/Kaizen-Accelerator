...
| 5 | C-UX-FUTURISTIC-P3 | Luminous Constraint Phase 3: Cadence Pressure Ring signature | improvement | 15 | 7 | **OPEN — depends on Phase 2** | 56px SVG arc in Today header divided into 3 color-coded segments (green/yellow/purple) proportional to planned minutes per bucket. Hover reveals breakdown tooltip. Updates real-time as blocks close. The "memorable signature" per frontend-design skill. ~10-14 hr. HIGH risk per QA (CCC bound at capacity — must update bound to ≤5). 0 §6.5 hits expected. |
