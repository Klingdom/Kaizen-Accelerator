...
| 2 | C-UX-6b | Focus-trap rollout to remaining 8 dialogs | fix | 14 | 1 (Frontend audit) | OPEN | After C-UX-6 (Iter 24) extracted reusable `installFocusTrap` utility, 8 other dialogs identified as needing rollout: BaselineDialog, KaizenCloseDialog, OpportunityIntakeForm, OutputArtifactDialog, ReflectionSheet, RemeasurementDialog, SkipReasonModal, WeeklyReflectionWizard. Estimated 2 hours; identical pattern. Score 14 = base 14 (I 4 / S 4 / L 2 / C 5 / E 1 / R 0 + ConvergenceBonus 0). Capped per §6.4 single-lens gate (would be score 14 with multi-lens; ships as-is given high confidence + low effort). |
