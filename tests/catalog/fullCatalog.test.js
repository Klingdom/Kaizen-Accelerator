...
describe('fullCatalog — Node pipeline path', () => {
  ...
  test('getFullCatalog returns 85 entries (Iter 26: +1 recovery_lunch; Phase 1: +4 convergent Tier 1; Phase 2: +6 lens-unique Tier 1; Phase 3: +10 Tier 2; Phase 4: +4 Tier 3)', async () => {
  ...
  test('getCachedCatalog returns the cached array after first load', async () => {
    ...
    assert.equal(cached.length, 85); // Iter 26: +1 recovery_lunch; Phase 1: +4; Phase 2: +6; Phase 3: +10; Phase 4: +4
  });
