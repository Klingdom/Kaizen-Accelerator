...
describe('buildCeremoniesAndGenerics — sizes and shape', () => {
  ...
  test('produces exactly 22 entries (6 ceremonies + 16 generics incl. Iter 26 recovery_lunch + Phase 1 +4 + Phase 2 +6)', () => {
  ...
  test('16 generic ids are all present (incl. Lessons Learned + Iter 26 recovery_lunch + Phase 1 +4 + Phase 2 +6)', () => {
    const ids = new Set(all.map((e) => e.id));
