...
describe('exportFullCatalog — build-script behavior', () => {
  ...
  test('file contents parse as JSON array of 71 entries (Iter 26: +1 recovery_lunch; Phase 1: +4 convergent Tier 1; Phase 2: +6 lens-unique Tier 1)', () => {
