...
describe('buildCatalog — orchestration', () => {
  ...
  test('produces 81 entries (49 numbered + 6 ceremonies + 26 generics incl. Iter 26 recovery_lunch + Phase 1 +4 + Phase 2 +6 + Phase 3 +10)', () => {
    assert.equal(EXPECTED_CATALOG_SIZE, 81);
