...
describe('buildCatalog — orchestration', () => {
  ...
  test('produces 85 entries (49 numbered + 6 ceremonies + 30 generics incl. Iter 26 recovery_lunch + Phase 1 +4 + Phase 2 +6 + Phase 3 +10 + Phase 4 +4)', () => {
    assert.equal(EXPECTED_CATALOG_SIZE, 85);
